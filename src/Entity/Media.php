...
class Media
{
    ...
    private ?\DateTimeInterface $releasedDateAt = null;
    ...
    public function getReleasedDateAt(): ?\DateTimeInterface
    {
        return $this->releasedDateAt;
    }

    public function setReleasedDateAt(\DateTimeInterface $releasedDateAt): static
    {
        $this->releasedDateAt = $releasedDateAt;
